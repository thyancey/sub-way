...
func apply_dialogue_line() -> void:
	...
	character_label.text = tr(_get_character_display_name(dialogue_line.character), "dialogue")
	portrait.set_character(dialogue_line.character.to_lower())
...
func _get_character_display_name(character_id: String) -> String:
	if character_names.has(character_id):
